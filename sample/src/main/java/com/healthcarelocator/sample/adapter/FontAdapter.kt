...
class FontAdapter : OneKeyAdapter<HeathCareLocatorViewFontObject, FontAdapter.FontVH>(arrayListOf(R.layout.layout_item_font)) {
    ...
    inner class FontVH(itemView: View) : OneKeyViewHolder<HeathCareLocatorViewFontObject>(itemView) {

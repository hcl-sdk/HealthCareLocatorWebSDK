 ...
 * </pre>
 */
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher, OnColorPickedListener {
    ...
    View createPickerView() {
        ...
        rgbView = contentView.findViewById(R.id.rgbView);
        rgbView.setListener(this);
        try {
        ...
        setHex(color);
        rgbView.setRgba(getRgbaFromHex(getHex(color)));
    ...
    public void onColorChanged(int newColor) {
        ...
        if (!fromEditText && hexEditText != null && rgbView != null) {
            setHex(newColor);
...
//            rgbView.detectTouchAction();
        }
        fromEditText = false;

        rgbView.setRgba(getRgbaFromHex(getHex(newColor)));
    }
    ...
    @Override
    public void onColorPicked(@Nullable Object pickerView, int color) {
        colorPicker.setColor(color, true);
    }
    ...
    public static final class Builder {
        ...
        public ColorPickerDialog create() {
            ...
            dialog.colorPickerDialogListener = this.colorPickerDialogListener;
            return dialog;
        }

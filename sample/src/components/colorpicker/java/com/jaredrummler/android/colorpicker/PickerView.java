...
import com.jaredrummler.android.colorpicker.interfaces.PickerTheme;
        ...
        if (alpha != null) {
            ...
            SeekBarUtils.setProgressBarColor(
                    ...
                    ColorUtils.fromAttr(getContext(), R.attr.neutralColor,
                            ColorUtils.fromAttrRes(getContext(), android.R.attr.textColorPrimary, R.color.cpv_colorPickerDialog_neutral))
            );
        }
    }

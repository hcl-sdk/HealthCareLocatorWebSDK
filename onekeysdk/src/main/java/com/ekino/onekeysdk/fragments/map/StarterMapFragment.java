...
public class StarterMapFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        GeoPoint point1 = new GeoPoint(10.76857, 106.65296);
        GeoPoint point2 = new GeoPoint(10.761523, 106.662225);
        Marker marker1 = new Marker(mMapView);
        marker1.setPosition(point1);
        marker1.setAnchor(Marker.ANCHOR_CENTER, 1f);
        marker1.setIcon(ContextCompat.getDrawable(getContext(), R.drawable.baseline_location_on_black_36dp));
        marker1.setTitle("Position 1");
        mMapView.getOverlays().add(marker1);
        Marker marker2 = new Marker(mMapView);
        marker2.setPosition(point2);
        marker2.setIcon(ContextCompat.getDrawable(getContext(), R.drawable.baseline_location_on_black_36dp));
        marker2.setTitle("San van dong Thong Nhat");
        marker2.setAnchor(Marker.ANCHOR_CENTER, 1f);
...
//        mMapView.getController().animateTo(new GeoPoint(latitude,
//                longitude), 15.0, 500L);

...
class AddressObject(var id: String = "", var longLabel: String = "", var country: String = "",
                    var postalCode: String = "", var county: LabelObject? = null, var city: LabelObject? = null,
                    var location: LocationObject? = null) : Parcelable {
    constructor(parcel: Parcel) : this(
            parcel.readString() ?: "", parcel.readString() ?: "", parcel.readString() ?: "",
            parcel.readString() ?: "", parcel.readParcelable(LabelObject::class.java.classLoader),

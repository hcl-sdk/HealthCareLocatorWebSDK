...
@Component({
  tag: 'onekey-sdk-icon-refresh',
  shadow: false,
})
export class OnekeySdkIconRefresh {
  @Prop() color: string;
  ...
  render() {
    return (
      <Host>
        <svg 
          version="1.1"
          x="0px" y="0px" viewBox="0 0 458.186 458.186"
          width={this.width}
          height={this.height}
          fill={this.color}
          style={{enableBackground: 'new 0 0 458.186 458.186'}} xmlSpace="preserve"
        >
          <g>
            <g>

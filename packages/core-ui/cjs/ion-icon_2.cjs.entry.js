...
const provider = require('./provider-a98f4ad7.js');
...
provider.RouterStore.injectProps(OneKeySDKRouterLink, ['setActivatedRoute', 'activatedRoute']);

exports.ion_icon = Icon;
exports.onekey_sdk_router_link = OneKeySDKRouterLink;

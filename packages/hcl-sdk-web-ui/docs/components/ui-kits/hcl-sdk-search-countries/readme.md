...
| `data`                 | --                       |             | `{ code: "BE" \| "CA" \| "CO" \| "DE" \| "ES" \| "FR" \| "GB" \| "UK" \| "IT" \| "NL" \| "PL" \| "PT" \| "SA" \| "US" \| "AU" \| "AT" \| "HR" \| "BK" \| "GR" \| "IL" \| "MA" \| "SE" \| "CH" \| "TH" \| "IE" \| "TR" \| "BG" \| "NO" \| "DK" \| "FI" \| "HU" \| "SK" \| "LU" \| "KR" \| "BR" \| "NZ"; label: string; }[]` | `undefined` |
| `selectedCountry`      | `selected-country`       |             | `"BE" \| "CA" \| "CO" \| "DE" \| "ES" \| "FR" \| "GB" \| "UK" \| "IT" \| "NL" \| "PL" \| "PT" \| "SA" \| "US" \| "AU" \| "AT" \| "HR" \| "BK" \| "GR" \| "IL" \| "MA" \| "SE" \| "CH" \| "TH" \| "IE" \| "TR" \| "BG" \| "NO" \| "DK" \| "FI" \| "HU" \| "SK" \| "LU" \| "KR" \| "BR" \| "NZ"`                             | `undefined` |

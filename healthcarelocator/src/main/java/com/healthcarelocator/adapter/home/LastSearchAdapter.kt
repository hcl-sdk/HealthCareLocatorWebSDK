...
class LastSearchAdapter(private val theme: HealthCareLocatorCustomObject =
        ...
        HCLAdapter<SearchObject, LastSearchAdapter.LastSearchVH>(arrayListOf(R.layout.layout_one_key_last_search)) {
    ...
    inner class LastSearchVH(itemView: View) : HCLViewHolder<SearchObject>(itemView) {

...
data class HCLLocation(var id: String = "", var name: String = "", var speciality: String = "",
    ...
    companion object CREATOR : Parcelable.Creator<HCLLocation> {
        override fun createFromParcel(parcel: Parcel): HCLLocation {
            return HCLLocation(parcel)
        }

        override fun newArray(size: Int): Array<HCLLocation?> {
